         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="col-sm-12 col-xs-12">
                  <form class="from-prevent-multiple-submits" method="POST" action="{{route('users.update',$user->id)}}" onsubmit="return Validate()" name="vform">
                     @csrf
                     <div class="row">
                        ...
                        <div class="col-lg-4">
                           <div class="form-group">
                              ...
                              <input type="text" name="number" value="{{old('number', $user->number)}}" class="form-control textInput" placeholder="Enter Customer Mobile number">
                              @error('number')
                              <label class="error">{{ $message }}</label>
                              @enderror
                           </div>
                        ...
                        <div class="col-lg-6" id="role_div">
                           <div class="form-group">
                              ...
                              <select class="form-control textInput" id="val-skill" name="role_id">
                                 ...
                                 <option value="{{old('role_id', $item->id)}}" @if($item->id == $user->role_id) selected @endif>{{$item->name}}</option>
                                 @endforeach
                        ...
                        <div class="col-lg-6" id="siep_div">
                           <div class="form-group">
                              ...
                              <select class="form-control textInput" id="val-skill" name="siep_id">
                                 ...
                                 <option value="{{old('siep_id', $item->id)}}" @if($item->id == $user->siep_id) selected @endif>{{$item->siep_name}}</option>
                                 @endforeach
                     ...
                     <div class="row">
                        <div class="col-lg-4">
                           <div class="form-group">
                              ...
                              <select class="form-control textInput" id="unit_id" name="unit_id">
                                 ...
                                 <option value="{{old('unit_id', $item->id)}}" @if($item->id == $userregister->unit_id) selected @endif>{{$item->unit_name}}</option>
                                 @endforeach
                                 @error('unit_id')
                                 <label class="error">{{ $message }}</label>
                                 @enderror
                        ...
                        <div class="col-lg-4">
                           <div class="form-group">
                              ...
                              <select class="form-control" name="subunit_id" id="subunit_id">
                                 ...
                                 <option value="{{old('subunit_id', $item->id)}}" @if($item->id == $userregister->subunit_id) selected @endif>{{$item->subunit_name}}</option>
                                 @endforeach
                              </select>
                              @error('subunit_id')
                              <label class="error">{{ $message }}</label>
                        ...
                        <div class="col-lg-4">
                           <div class="form-group">
                              ...
                              <div class="row">
                                 <div class="col-lg-3">
                                    <input type="radio" {{ $userregister->clinical_status == '1' ? 'checked' : '' }} value="1" id="clinical_status" name="clinical_status" class="form-check-input">
                                    <label class="form-check-label" for="customRadio11">Yes</label>
                                 </div>
                                 <div class="col-lg-3">
                                    <input type="radio" {{ $userregister->clinical_status == '0' ? 'checked' : '' }} value="0" id="clinical_status" name="clinical_status" class="form-check-input">
