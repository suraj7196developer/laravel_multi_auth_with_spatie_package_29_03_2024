...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('userdashboard.roles.index',['roles'=>$role]);
    }
    ...
    public function create()
    {
        ...
        return view('userdashboard.roles.create',['permissions'=>$permissions]);
    }
    ...
    public function edit(Role $role)
    {
        ...
        $role->permissions;
       return view('userdashboard.roles.edit',['role'=>$role,'permissions' => $permission]);
    }
    ...
    public function update(Request $request, Role $role)
    {
        ...
        $role->syncPermissions($request->permissions);
        return redirect()->route('admin.roles.index')->with('info', 'Role updated !!!');
    }
