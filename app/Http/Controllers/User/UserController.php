...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('userdashboard.users.index',['users'=>$user]);
    }
    ...
    {
        $roles = Role::get();
        return view('userdashboard.users.create',['roles'=>$roles]);
    }
    ...
    public function edit(User $user)
    {
        $role = Role::get();
        $user->roles;
       return view('userdashboard.users.edit',['user'=>$user,'roles' => $role]);
    }
